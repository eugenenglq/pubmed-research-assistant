...
output "web_app_ecr_repository_name" {
  description = "The name of the ECR repository for the web app"
  value       = aws_ecr_repository.web_app.name
}

output "pubmed_ingest_data_ecr_repository_name" {
  description = "The name of the ECR repository for the ingest data"
  value       = aws_ecr_repository.pubmed_ingest_data.name
}

output "search_os_pubmed_lambda_repository_name" {
  description = "The name of the ECR repository for the search os pubmed lambda function"
  value       = aws_ecr_repository.search_os_pubmed_lambda.name
}
